...
export const ApiGrpc = {
  ...
  methods: {
    ...
    /**
     * @generated from rpc arroyo_api.ApiGrpc.GetSource
     */
    getSource: {
      name: "GetSource",
      I: GetSourceReq,
