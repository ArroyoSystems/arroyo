...
export const ApiGrpc = {
  ...
  methods: {
    ...
    /**
     * @generated from rpc arroyo_api.ApiGrpc.ReadState
     */
    readState: {
      name: "ReadState",
      I: ReadStateReq,
