...
use arrow_schema::{Schema, SchemaRef, TimeUnit};
use arroyo_connectors::Connection;
use arroyo_datastream::{ArroyoSchema, Program, TIMESTAMP_FIELD, WindowType};
...
impl TryFrom<&DataFusionEdge> for LogicalEdge {
