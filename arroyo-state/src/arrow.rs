...
use arroyo_rpc::grpc::api::ArroyoSchema;

// pub struct TimeKeyMap<'a, S: BackingStore> {
//     table: char,
//     store: &'a mut S,
//     cache: &'a mut TimeKeyMapCache,
// }
//
// impl<'a, S: BackingStore> TimeKeyMap<'a, S> {
//     pub fn new(table: char, parquet: &'a mut S, cache: &'a mut TimeKeyMapCache) -> Self {
//         Self {
//             table,
//             store: parquet,
//             cache,
