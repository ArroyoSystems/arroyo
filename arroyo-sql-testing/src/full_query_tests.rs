...
async fn run_pipeline_and_assert_outputs(
    ...
    // sort the lines of output and golden output
    output_lines.sort();
    golden_output_lines.sort();
    println!("sorted output lines");
    output_lines
        .into_iter()
