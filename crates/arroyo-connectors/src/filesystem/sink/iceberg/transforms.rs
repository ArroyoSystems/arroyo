...
pub fn transform_arrow(array: ArrayRef, transform: Transform) -> Result<ArrayRef, ArrowError> {
    match (array.data_type(), transform) {
        ...
        (DataType::Time32(TimeUnit::Millisecond), Transform::Bucket { arg0: n }) => {
            let temp = cast(&array, &DataType::Int32)?;
...
make_transform_udf!(
    ...
    |args: &ScalarFunctionArgs| {
        ...
        let arg0 = scalar_to_u32(&args.args[1], "ice_truncate", 2)?;
        Ok(Transform::Truncate { arg0 })
    },
);
...
make_transform_udf!(
    ...
    |args: &ScalarFunctionArgs| {
        ...
        let arg0 = scalar_to_u32(&args.args[1], "ice_bucket", 2)?;
        Ok(Transform::Bucket { arg0 })
    },
);
...
mod tests {
    ...
    fn test_int16_truncate_transform() {
        ...
        let result = transform_arrow(array, Transform::Truncate { arg0: 10 }).unwrap();
    ...
    fn test_int32_truncate_transform() {
        ...
        let result = transform_arrow(array, Transform::Truncate { arg0: 100 }).unwrap();
        let expected = Arc::new(arrow::array::Int32Array::from(vec![
    ...
    fn test_int64_truncate_transform() {
        ...
        let result = transform_arrow(array, Transform::Truncate { arg0: 1000 }).unwrap();
    ...
    fn test_int32_bucket_transform() {
        ...
        let result = transform_arrow(array, Transform::Bucket { arg0: 1000 }).unwrap();
        let expected = Arc::new(arrow::array::Int32Array::from(vec![
